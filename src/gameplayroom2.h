...
#ifndef RAYLIBSTARTER_GAMEPLAYROOM2_H
#define RAYLIBSTARTER_GAMEPLAYROOM2_H
...
class gameplayroom2 : public scene{
public:
    ...
    int rows;
    int cols;
    Vector2 nextdoor {11*32+16, 16};
    Vector2 lastdoor {16,8*32+16 };
    gameplayroom2();
...
#endif //RAYLIBSTARTER_GAMEPLAYROOM2_H
