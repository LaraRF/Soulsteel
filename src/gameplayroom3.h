...
#ifndef RAYLIBSTARTER_GAMEPLAYROOM3_H
#define RAYLIBSTARTER_GAMEPLAYROOM3_H
...
class gameplayroom3 : public scene{
public:
    ...
    int rows;
    int cols;
    Vector2 nextdoor {16, 3*32+16};
    Vector2 lastdoor {11*32+16,14*32+16 };
    gameplayroom3();
...
#endif //RAYLIBSTARTER_GAMEPLAYROOM3_H
